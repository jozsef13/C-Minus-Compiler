...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_END_OF_INSTRUCTION = 27,        /* END_OF_INSTRUCTION  */
  YYSYMBOL_COMMA = 28,                     /* COMMA  */
  YYSYMBOL_LEFT_PARANTHESIS = 29,          /* LEFT_PARANTHESIS  */
  YYSYMBOL_RIGHT_PARANTHESIS = 30,         /* RIGHT_PARANTHESIS  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "END", "ELSE", "IF",
  "INT", "LONG", "DOUBLE", "FLOAT", "SHORT", "UNSIGNED", "VOLATILE",
  "RETURN", "VOID", "WHILE", "ADD", "SUBSTRACT", "MULTIPLY", "DIVIDE",
  "SMALLER", "SMALLER_OR_EQUAL", "GREATER", "GREATER_OR_EQUAL", "EQUAL",
  "NOT_EQUAL", "ASSIGN", "END_OF_INSTRUCTION", "COMMA", "LEFT_PARANTHESIS",
  "RIGHT_PARANTHESIS", "LEFT_BRACKET", "RIGHT_BRACKET", "LEFT_BRACE",
  "RIGHT_BRACE", "ID", "NUM", "$accept", "program", "declaration_list",
...
#line 83 "C-Minus.y"
                       { astRoot = createProgramNode((yyvsp[0].node)); (yyval.node) = astRoot; }
...
#line 88 "C-Minus.y"
                                   {  (yyval.node) = (yyvsp[-1].node); addLinkToList((yyvsp[-1].node), (yyvsp[0].node)); }
